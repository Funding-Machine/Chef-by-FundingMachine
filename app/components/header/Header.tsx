      ...
      <div className="z-40 flex cursor-pointer items-center gap-4 text-content-primary">
        ...
        <a href="/" className="flex items-center transition-opacity hover:opacity-90">
          <h1 className="text-lg font-bold tracking-tight">
            <span className="bg-gradient-to-r from-[#7ECBFB] to-[#269FE0] bg-clip-text text-transparent">
              Funding Machine AI
            </span>
            <span className="ml-2 text-xs font-medium text-content-secondary opacity-75">
              powered by Chef
            </span>
          </h1>
        </a>
